...
parser.add_argument("-d","--dataset", type=str, default="cifar100im", help="")
parser.add_argument("-e","--no_of_epochs", type=int, default=200, help="Number of epochs for the active learner")
parser.add_argument("-m","--method_type", type=str, default="CoreGCN", help="")
...
parser.add_argument("-g","--gpu-id", type=int, default=4)
...
if __name__ == '__main__':
    ...
    datasets = ['cifar10','cifar10im', 'cifar100', 'cifar100im', 'fashionmnist','svhn']
