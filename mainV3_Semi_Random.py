...
from train_test_V3 import train3, test3
from load_dataset import load_dataset
from selection_methods_V3 import *
from config import *
...
if __name__ == '__main__':
    ...
    for trial in range(TRIALS):
        ...
        for cycle in range(CYCLES):
            ...
            train3(models, method, criterion, optimizers, schedulers, dataloaders, args.no_of_epochs, EPOCHL)
            ...
            arg = query_samples3(models, method, data_unlabeled, subset, labeled_set, cycle, args)
