...
from train_test_V4 import train4, test4
from load_dataset import load_dataset
from selection_methods_V4 import *
from config import *
...
if __name__ == '__main__':
    ...
    for trial in range(TRIALS):
        ...
        for cycle in range(CYCLES):
            ...
            train4(models, method, criterion, optimizers, schedulers, dataloaders, args.no_of_epochs, EPOCHL)
            acc = test4(models, EPOCH, method, dataloaders, mode='test')
            ...
            arg = query_samples4(models, method, data_unlabeled, subset, labeled_set, cycle, args)
