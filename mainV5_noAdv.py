...
from train_test_V5 import train5, test5
from load_dataset import load_dataset
from selection_methods_V5 import *
from config import *
...
if __name__ == '__main__':
    ...
    for trial in range(TRIALS):
        ...
        for cycle in range(CYCLES):
            ...
            train5(models, method, criterion, optimizers, schedulers, dataloaders, args.no_of_epochs, EPOCHL)
            acc = test5(models, EPOCH, method, dataloaders, mode='test')
            ...
            arg = query_samples5(models, method, data_unlabeled, subset, labeled_set, cycle, args)
